        ...
        {!showResults ? (
          <>
            <div className="flex justify-between mb-10 items-center">
              <div className="bg-teal-600 text-white px-4 rounded-md py-1">
                <h2>
            ...
            <div>
              ...
              <ul>
                {answers.map((answer: string, idx: number) => (
                  <li
                    ...
                    className={`cursor-pointer mb-5 py-3 rounded-md hover:bg-teal-600 hover:text-white px-3 ${
                      selectedAnswerIndex === idx && "bg-teal-600 text-white"
                    }`}
                  >
                    <span>{answer}</span>
                  </li>
              ...
              <button onClick={nextQuestion} disabled={!checked} className="font-bold hover:text-teal-600">
          ...
          <div className="text-center">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-10">
              <StatCard title="Percentage" value={`${(results.score / (questions.length * 5)) * 100}%`} />
            ...
            <button onClick={() => window.location.reload()} className="mt-10 font-bold uppercase hover:text-teal-600">
              Restart Quiz
            </button>
          </div>
        )}
